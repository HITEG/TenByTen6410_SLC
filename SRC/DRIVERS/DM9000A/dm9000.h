...
class C_DM9000 : public NIC_DEVICE_OBJECT
{
    public:
        ...
        virtual U16 DeviceReadPhy(U32 nP_addr, U32 nP_reg);
        virtual U16 DeviceWritePhy(U32 nP_addr, U32 nP_reg, U16 nOff);
        ...
        virtual void TX_SEND_CHECK(void);
        ...
        U32 DeviceCheckLink(void);
        virtual void REG_INDEX_SAVE(void);
        virtual void REG_INDEX_RESTORE(void);
        virtual void PRINT_REG_DATA(U8);
    ...
    public:
        ...
        int m_nMaxTxPending;
        int m_nTxPendings;
        U32 reg_index_save_data;
        U32 rec_buff_count;
        U32 soft_first_reset_delay;
        U32 link_off_reset;
};
