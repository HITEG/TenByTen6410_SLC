...
class NIC_DEVICE_OBJECT
{
    ...
    public:
        ...
        virtual U32 DeviceCheckLink(void) = 0; // abstract function ;Public for inheritance
        virtual void REG_INDEX_SAVE(void) = 0;
        virtual void REG_INDEX_RESTORE(void) = 0;
...
#define DeviceReceiveIndication(a, b, c)    m_pUpper->DriverReceiveIndication(a, b, c)
#endif
